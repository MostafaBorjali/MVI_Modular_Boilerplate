...
val LocalColors = compositionLocalOf {  MviModularLightColors}
...
internal val MviModularLightColors = Colors(
    ...
    navbarItemColor = Orange500,
    backgroundSearchColor = Black50,
    navbarBackgroundColor = White500_75,
    bottomSheetBackgroundColor = White700,
    surfaceColor = White600,
    primaryGradiantStart = PrimaryGradiantStart,
    primaryGradiantEnd = PrimaryGradiantEnd,
)
internal val MviModularDArkColors = Colors(
    blackLabelColorPrimary = White500,
    whiteLabelColorPrimary = White500,
    primaryColor = Black500,
    secondaryColor = White500,
    errorColor = Orange500,
    successColor = Green500,
    backgroundSearchColor = Black50,
    navbarBackgroundColor = Black500,
    navbarItemColor = Yellow500,
    bottomSheetBackgroundColor = Black400,
    surfaceColor = Black400,
    primaryGradiantStart = PrimaryGradiantStart,
    primaryGradiantEnd = PrimaryGradiantEnd,
)
